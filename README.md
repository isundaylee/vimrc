...
* **Basic**: If you want something small just copy [basic.vim](https://github.com/isundaylee/vimrc/blob/master/vimrcs/basic.vim) into your ~/.vimrc and you will have a great basic setup
...
The basic version is basically just one file and no plugins. You can check out [basic.vim](https://github.com/isundaylee/vimrc/blob/master/vimrcs/basic.vim).
